...
QT_MOC_LITERAL(1, 14, 21), // "sendSelectionFinished"
QT_MOC_LITERAL(2, 36, 0), // ""
QT_MOC_LITERAL(3, 37, 12) // "capturedRect"

    },
    "CaptureWindow\0sendSelectionFinished\0"
    "\0capturedRect"
};
...
void CaptureWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->sendSelectionFinished((*reinterpret_cast< QRect(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (CaptureWindow::*)(QRect );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CaptureWindow::sendSelectionFinished)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CaptureWindow::sendSelectionFinished(QRect _t1)
{
