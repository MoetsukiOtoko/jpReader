...
public:
    ...
    GlobalMediator *setTextHolder(TextHolder *textholder);
    ~GlobalMediator() {}
...
Q_SIGNALS:
    void sendHideRequested();
    void sendShowRequested();
    void sendSelectedTextAudioRequested();
    void sendFFXIVAutoCaptureRequested();
    void sendAreaCaptureRequested();
    void sendTranslationRequested();
    void sendHideDefinition();
    void sendTranslationButtonPressed();
    void sendJpTextChanged(const QString& newtext);
    void sendKanaClicked(const QString& kana);
    void sendTermClicked(const QString& term);
    void sendShuttdown();
    void sendCloseOptions();
    void sendChangeTheme();
    void sendSubstringButtonPressed(int index);
